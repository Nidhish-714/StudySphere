...
prompt_template = PromptTemplate(
    ...
    template=(
        ...
        "Your task is to assist users with their queries related to WEB DEVELOPMENT concepts, applications, and recent advancements. "
...
# API endpoint to handle web development query
